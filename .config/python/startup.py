...
# Copied straight from cpython's site.py but with a different path to the history file
def __move_histfile():
    """Move ~/.python_history to another location specified using environment variables."""
    import sys
